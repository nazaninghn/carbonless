...
export default function SelectModePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10"
      style={{ background: 'linear-gradient(135deg, #F1FCF2 0%, #f5f5f5 50%, #F1FCF2 100%)' }}>
          ...
          {['en', 'tr'].map(l => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-[11px] font-bold uppercase transition ${
                language === l ? 'bg-[#072C0E] text-white' : 'text-[#072C0E]/40 hover:text-[#072C0E]'
              }`}
            >
              {l === 'en' ? 'EN' : 'TR'}
            </button>
      ...
      <div className="text-center mb-10">
        <h1 className="text-[28px] sm:text-[34px] font-extrabold text-[#072C0E] tracking-tight leading-tight">
          {t.title}
        </h1>
        <p className="mt-3 text-[14px] text-[#072C0E]/50 max-w-sm mx-auto leading-relaxed">
          {t.subtitle}
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-5 w-full max-w-2xl">
        ...
        <button
          ...
          style={{
            borderColor: hovered === 'ai' ? '#2ABD41' : '#e0e0e0',
            background: hovered === 'ai' ? 'linear-gradient(135deg, #F1FCF2, #F1FCF2)' : 'white',
            boxShadow: hovered === 'ai' ? '0 8px 32px rgba(42, 189, 65,0.15)' : '0 2px 8px rgba(0,0,0,0.04)',
          }}
        >
          {/* Icon */}
          <div className="h-14 w-14 rounded-2xl flex items-center justify-center"
            style={{ background: 'linear-gradient(135deg, #2ABD41, #1D9C31)' }}>
            <Brain className="h-7 w-7 text-white" />
          </div>

          {/* Badge */}
          <div className="absolute top-4 right-4 rounded-full px-2.5 py-0.5 text-[10px] font-bold"
            style={{ background: '#51D766', color: '#072C0E' }}>
            {t.recommended}
          </div>

          <div>
            <h2 className="text-[18px] font-bold text-[#072C0E]">{t.aiTitle}</h2>
            <p className="mt-1.5 text-[13px] text-[#072C0E]/55 leading-relaxed">
              {t.aiDesc}
            </p>
          </div>

          <ul className="space-y-1.5 text-[12px] text-[#072C0E]/55">
            <li className="flex items-center gap-2"><Sparkles className="h-3.5 w-3.5" style={{color:'#2ABD41'}} />{t.aiF1}</li>
            <li className="flex items-center gap-2"><Leaf className="h-3.5 w-3.5" style={{color:'#2ABD41'}} />{t.aiF2}</li>
            <li className="flex items-center gap-2"><Activity className="h-3.5 w-3.5" style={{color:'#2ABD41'}} />{t.aiF3}</li>
          </ul>
        ...
        <button
          ...
          className="group relative flex flex-col items-start gap-5 rounded-2xl border-2 p-7 text-left transition-all duration-200 hover:scale-[1.02] active:scale-[0.99]"
          style={{
            borderColor: hovered === 'dashboard' ? '#51D766' : '#e0e0e0',
            background: hovered === 'dashboard' ? 'linear-gradient(135deg, #F1FCF2, #F1FCF2)' : 'white',
            boxShadow: hovered === 'dashboard' ? '0 8px 32px rgba(81, 215, 102,0.15)' : '0 2px 8px rgba(0,0,0,0.04)',
          }}
        >
          {/* Icon */}
          <div className="h-14 w-14 rounded-2xl flex items-center justify-center"
            style={{ background: 'linear-gradient(135deg, #51D766, #2ABD41)' }}>
            <BarChart3 className="h-7 w-7 text-white" />
          </div>

          <div>
            <h2 className="text-[18px] font-bold text-[#072C0E]">{t.dashTitle}</h2>
            <p className="mt-1.5 text-[13px] text-[#072C0E]/55 leading-relaxed">
              {t.dashDesc}
            </p>
          </div>
          ...
          <ul className="space-y-1.5 text-[12px] text-[#072C0E]/55">
            <li className="flex items-center gap-2"><BarChart3 className="h-3.5 w-3.5" style={{color:'#51D766'}} />{t.dashF1}</li>
            <li className="flex items-center gap-2"><Activity className="h-3.5 w-3.5" style={{color:'#51D766'}} />{t.dashF2}</li>
            <li className="flex items-center gap-2"><Leaf className="h-3.5 w-3.5" style={{color:'#51D766'}} />{t.dashF3}</li>
          </ul>
      ...
      {/* Note */}
      <p className="mt-8 text-[11px] text-[#072C0E]/35 text-center">
        {t.note}
      </p>
      ...
      <button
        ...
        className="mt-4 text-[11px] text-[#072C0E]/30 hover:text-[#072C0E]/60 transition underline underline-offset-2"
      >
        {t.logout}
      </button>
    </div>
