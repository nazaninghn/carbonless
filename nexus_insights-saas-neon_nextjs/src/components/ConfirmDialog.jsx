    ...
    >
      <div className="w-full max-w-sm animate-in rounded-[1.5rem] border border-[#302817]/10 bg-white/92 p-6 shadow-[0_20px_60px_rgba(48,40,23,0.15)] backdrop-blur-2xl">
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button
            onClick={onConfirm}
            className={`flex-1 rounded-full py-3 text-sm font-bold text-white shadow-lg transition-colors ${type === 'danger' ? 'bg-red-500 shadow-red-500/20 hover:bg-red-600' : 'bg-[#302817] shadow-[#302817]/15 hover:bg-[#5E6B2A]'}`}
          >
            {confirmText || 'Confirm'}
          </button>
        </div>
