        ...
        {checkItems.map(({ key, label, ok }) => (
          <li key={key} className="flex items-center gap-1.5 text-xs">
            {ok ? (
              ...
              <svg className="w-3.5 h-3.5 text-[#072C0E]/40 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span className={ok ? 'text-green-700' : 'text-[#072C0E]/55'}>{label}</span>
          </li>
        ))}
      </ul>
    </div>
