      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={handleClose} className="text-graphite/60 hover:text-graphite transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          {/* Title */}
          <h2 className="text-xl font-bold text-slate mb-3">{current.title}</h2>

          {/* Description */}
          <p className="text-graphite leading-relaxed mb-4">{current.description}</p>
          ...
          <div className="flex items-center justify-between">
            <button
              onClick={handleClose}
              className="text-sm text-graphite hover:text-slate transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              {!isFirst && (
                <button
                  onClick={handlePrev}
                  className="px-4 py-2 border border-black/[0.06] text-slate rounded-lg hover:bg-mist transition-colors flex items-center gap-1 text-sm"
                >
