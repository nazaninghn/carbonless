  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 max-w-md">
      <div>
        ...
        <input type="password" value={oldPw} onChange={e => setOldPw(e.target.value)} className="w-full px-3 py-2 border border-[#302817]/10 rounded-xl text-sm outline-none focus:border-[#95A847] focus:ring-2 focus:ring-[#95A847]/20" required />
      </div>
      <div>
        <label className="block text-xs text-[#302817]/55 mb-1">{tr ? 'Yeni Şifre' : 'New Password'}</label>
        <input type="password" value={newPw} onChange={e => setNewPw(e.target.value)} className="w-full px-3 py-2 border border-[#302817]/10 rounded-xl text-sm outline-none focus:border-[#95A847] focus:ring-2 focus:ring-[#95A847]/20" required />
      ...
      <div>
        ...
        <input type="password" value={confirm} onChange={e => setConfirm(e.target.value)} className="w-full px-3 py-2 border border-[#302817]/10 rounded-xl text-sm outline-none focus:border-[#95A847] focus:ring-2 focus:ring-[#95A847]/20" required />
      </div>
