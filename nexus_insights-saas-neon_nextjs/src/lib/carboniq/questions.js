...
export const CARBONIQ_QUESTIONS = [
  ...
  },
  {
    ...
    type: 'info',
    required: false,
    reportField: 'scope3.cat3.auto',
    text: {
      tr: 'Kategori 3 otomatik hesaplandı — onayınızı bekliyoruz.',
      en: 'Category 3 calculated automatically — please confirm.',
    },
    helper: {
      tr: 'Kapsam 3 Kategori 3 (Yakıt ve Enerji İlişkili Faaliyetler), Kapsam 1 yakıt verilerinizden WTT (Well-to-Tank) faktörleri ve Kapsam 2 elektrik tüketiminizden T&D (iletim ve dağıtım) kayıpları kullanılarak otomatik hesaplanmaktadır. Bu kategori ISO 14064-1 kapsamında her zaman raporlanması gereken bir kategoridir. Devam etmek için "Anladım, devam et" butonuna tıklayın.',
      en: 'Scope 3 Category 3 (Fuel- and Energy-Related Activities) is automatically calculated using WTT (Well-to-Tank) factors from your Scope 1 fuel data and T&D (transmission and distribution) losses from your Scope 2 electricity consumption. This category must always be reported under ISO 14064-1. Click "Got it, continue" to proceed.',
    },
    next: 'K3C4-1',
  },
  {
  ...
  },
  {
    ...
    required: false,
    text: {
      tr: 'Kabuller — Raporunuzda kullanılan varsayımları birlikte gözden geçirelim.',
      en: 'Assumptions — Let\'s review the assumptions used in your report.',
    },
    helper: {
      tr: 'ISO 14064-1 §7.3, raporlanan verilerde kullanılan tüm önemli kabuller ve varsayımların belgelenmesini zorunlu kılar. Bir kabul; veri eksikliğini kapatmak (Tip A), metodoloji seçimini gerekçelendirmek (Tip B) veya kapsam kararlarını açıklamak (Tip C) amacıyla kullanılmış olabilir. Bir sonraki adımda metodoloji kabullerinizi girecek ve veri boşluklarını onaylayacaksınız.',
      en: 'ISO 14064-1 §7.3 requires all significant assumptions used in reported data to be documented. An assumption may be used to fill a data gap (Type A), justify a methodology choice (Type B), or explain a scoping decision (Type C). In the next step you will enter methodology assumptions and confirm data gaps.',
    },
    next: '6B-1',
  },
  {
  ...
  },
  {
    ...
    type: 'single_select',
    required: true,
    reportField: 'assumptions.approved',
    text: {
      tr: 'Raporunuzdaki tüm kabuller ve varsayımlar gözden geçirildi. Yayınlamak üzere onaylıyor musunuz?',
      en: 'All assumptions in your report have been reviewed. Do you approve them for publication?',
    },
    helper: {
      tr: 'Onaylamanız, bu kabuller ve varsayımlar ISO 14064-1 §7.3 uyarınca raporunuzda belgeleneceği anlamına gelir.',
      en: 'Your approval means these assumptions will be documented in your report in accordance with ISO 14064-1 §7.3.',
    },
    options: [
      { value: 'approved', label: { tr: 'Evet, tüm kabulleri onaylıyorum', en: 'Yes, I approve all assumptions' } },
      { value: 'needs_revision', label: { tr: 'Hayır, gözden geçirmem gerekiyor', en: 'No, I need to revise' } },
    ],
    validate: {
      requiredMessage: { tr: 'Lütfen bir seçenek belirtin.', en: 'Please select an option.' },
    },
