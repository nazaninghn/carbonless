...
class QuestionnaireTests(TestCase):
    ...
    def test_start_session(self):
        res = self.client.post('/api/questionnaire/legacy/start/', {'lang': 'en'}, format='json')
    ...
    def test_answer_question(self):
        start = self.client.post('/api/questionnaire/legacy/start/', {'lang': 'en'}, format='json')
        sid = start.data['session_id']
        res = self.client.post('/api/questionnaire/legacy/answer/', {
    ...
    def test_reset_session(self):
        self.client.post('/api/questionnaire/legacy/start/', {'lang': 'en'}, format='json')
        res = self.client.post('/api/questionnaire/legacy/reset/', format='json')
        self.assertEqual(res.status_code, 200)

    def test_profile_not_started(self):
        res = self.client.get('/api/questionnaire/legacy/profile/')
        self.assertEqual(res.status_code, 200)
